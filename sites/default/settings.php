...
$settings['config_sync_directory'] = 'sites/default/files/config_acqTmp-2020-10-08T10.57.08-2074/sync';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_THT2_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_THT2_dd.inc';
}
// </DDSETTINGS>
